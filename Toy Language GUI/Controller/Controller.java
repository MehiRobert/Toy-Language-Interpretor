...
public class Controller {
    ...
    public Controller(){}
    public Controller(Repo R) {repo = R; executor = Executors.newFixedThreadPool(2);}
    ...
    public void OnlyOneStep() throws InterruptedException {
...
//        }
    ...
    {
        var newlist = removeCompletedPrg(repo.getPrgList());
        repo.setPrgList(newlist);
        return this.repo.getPrgList();
    }
}
